...
export type Hardware = {
	...
	// Marks a part interchangeable with another (e.g. socket vs button head).
	// `true` = a bare "Interchangeable" tag; a string names what it swaps with.
	interchangeable?: string | boolean | null;
};
